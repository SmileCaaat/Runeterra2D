...
@export_range(0.01, 2.0, 0.01) var hold_duration := 0.42
@export_range(0.01, 1.0, 0.01) var exit_duration := 0.14
@export_range(-1.0, 1.0, 0.01) var slant := -0.17
@export_range(0.001, 0.2, 0.001) var feather := 0.015
@export_range(0.25, 3.0, 0.01) var portrait_scale := 1.01
@export var portrait_offset := Vector2(0.10, -0.01)
