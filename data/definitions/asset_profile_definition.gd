...
@export_enum("character_model", "character_animation", "skill_vfx", "passive_vfx", "particle_vfx", "hit_vfx", "combat_text_font", "skill_icon", "status_icon", "hero_portrait", "audio") var asset_type := "skill_vfx"
